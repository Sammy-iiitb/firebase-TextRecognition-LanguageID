...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void processTextRecognitionResult(FirebaseVisionText texts) {
        // HERE COMES THE RESULT OF TEXT RETURNED BY THE CODE INTEGRATE LANGUAGE ID HERE
        ...
        for (int i = 0; i < blocks.size(); i++) {
            ...
            for (int j = 0; j < lines.size(); j++)
            {
                ...
                String textForIdCheck = blocks.get(i).getText();
                Log.i("id check", textForIdCheck);
                languageIdentification(textForIdCheck);
            }
        }
    }

    private void languageIdentification(String text)
    {
                ...
                .addOnFailureListener(
                        new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                // ...
                                Log.e(TAG, "Can't find the id of the language");
                            }
                        });
    }
